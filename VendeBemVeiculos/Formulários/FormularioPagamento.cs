...
namespace VendeBemVeiculos
{
    public partial class FormularioPagamento : Form
    {
        ...
        {
            this.labelValorCliente.Text = this.cliente.ToString();
            this.labelValorVendedor.Text = this.vendedor.ToString();
            this.labelValorVeiculo.Text = $"{this.veiculo.Marca} {this.veiculo.Modelo} {this.veiculo.Ano}";
            this.labelValorPreco.Text = $"R${string.Format("{0:0.00}", this.veiculo.Preco)}";
        }
